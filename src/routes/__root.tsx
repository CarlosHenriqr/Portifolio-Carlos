...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Full-stack development, internal systems and REST APIs by Carlos Henrique Ramos.",
      },
      { name: "author", content: "Carlos Henrique Ramos" },
    ],
    links: [
      ...
      { rel: "icon", href: "/favicon-ch.png", type: "image/png", sizes: "128x128" },
    ],
  }),
  ...
  return (
    <ReactLenis
      ...
      options={{
        ...
        anchors: reducedMotion ? false : { duration: 0.9 },
      }}
    >
